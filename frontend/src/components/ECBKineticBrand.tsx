...
const LETTERS: LetterMeta[] = [
  { char: "E", label: "Enterprise", accent: "#6366f1" },
  { char: "C", label: "Context", accent: "#8b5cf6" },
  { char: "B", label: "Brain", accent: "#22d3ee" },
];
...
export const ECBKineticBrand: React.FC<ECBKineticBrandProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -inset-[1px] -z-10 rounded-2xl bg-gradient-to-br from-[#6366f1]/18 via-[#8b5cf6]/12 to-[#22d3ee]/16 opacity-0 blur-[12px] transition-opacity duration-700 group-hover/brand:opacity-100" />
      {/* subtle top sheen */}
      ...
      {showIcon && (
        <div
          className="relative flex shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#6366f1] via-[#8b5cf6] to-[#22d3ee] shadow-[0_0_22px_rgba(99,102,241,0.45),0_4px_16px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.22)] ring-1 ring-white/15 transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover/brand:scale-[1.04] group-hover/brand:rotate-[3deg] group-hover/brand:shadow-[0_0_28px_rgba(99,102,241,0.55),0_0_42px_rgba(139,92,246,0.22)]"
      ...
      <div className="flex min-w-0 flex-1 flex-col items-center leading-none gap-0.5 text-center overflow-hidden">
                ...
                >
                  ...
                  <AuroraText
                    ...
                    className={cn(
                      ...
                      "hover:[padding-inline:var(--hover-padding)] hover:font-[900] hover:[-webkit-text-stroke-color:currentcolor] hover:[-webkit-text-stroke-width:calc(var(--text-stroke-width)*2)] hover:drop-shadow-[0_0_14px_rgba(99,102,241,0.45)]",
                  ...
                  <span
                    aria-hidden="true"
                    className={cn(
                      "inline-block overflow-hidden whitespace-nowrap bg-gradient-to-br from-[#6366f1] via-[#8b5cf6] to-[#22d3ee] bg-clip-text text-transparent dark:from-[#6366f1] dark:via-[#8b5cf6] dark:to-[#22d3ee] [background-size:200%_100%]",
        ...
        {showSublabel && (
          <span className="mt-1 block max-w-full overflow-hidden whitespace-nowrap text-center text-[0.50rem] font-bold uppercase tracking-[0.11em] text-[#64748b] dark:text-white/65">
            Powered By{" "}
            <span className="bg-gradient-to-r from-[#6366f1] via-[#8b5cf6] to-[#22d3ee] bg-clip-text font-extrabold text-transparent [background-size:200%_100%] animate-[ecbGradientShift_3.2s_ease_infinite]">
              Infoservices
            </span>
          </span>
        )}
