...
export const ContextScopeBar: React.FC<ContextScopeBarProps> = ({
  ...
  const DEFAULT_DOCS: Project[] = [
    { id: 'doc-01_enterprise_context_brain_architecture', name: '📄 01 Enterprise Context Brain Architecture', code: 'DOC', description: '', status: 'on_track' as any, health_score: 100, owner_name: 'sys', target_completion_date: '', created_at: '', updated_at: '', active_risks_count: 0, open_tickets_count: 0, recent_decisions_count: 0, milestones: [] } as any,
    { id: 'doc-02_databricks_mcp_agent_architecture', name: '📄 02 Databricks Agent MCP Architecture', code: 'DOC', description: '', status: 'on_track' as any, health_score: 100, owner_name: 'sys', target_completion_date: '', created_at: '', updated_at: '', active_risks_count: 0, open_tickets_count: 0, recent_decisions_count: 0, milestones: [] } as any,
    { id: 'doc-03_airflow_mcp_openwebui_architecture', name: '📄 03 Airflow MCP OpenWebUI Architecture', code: 'DOC', description: '', status: 'on_track' as any, health_score: 100, owner_name: 'sys', target_completion_date: '', created_at: '', updated_at: '', active_risks_count: 0, open_tickets_count: 0, recent_decisions_count: 0, milestones: [] } as any,
    { id: 'doc-04_virtual_receptionist_clara_bot_architecture', name: '📄 04 Virtual Receptionist Clara Bot Architecture', code: 'DOC', description: '', status: 'on_track' as any, health_score: 100, owner_name: 'sys', target_completion_date: '', created_at: '', updated_at: '', active_risks_count: 0, open_tickets_count: 0, recent_decisions_count: 0, milestones: [] } as any,
    { id: 'doc-github_poc_master_architecture', name: '📄 GitHub POC Master Architecture', code: 'DOC', description: '', status: 'on_track' as any, health_score: 100, owner_name: 'sys', target_completion_date: '', created_at: '', updated_at: '', active_risks_count: 0, open_tickets_count: 0, recent_decisions_count: 0, milestones: [] } as any,
  ];
